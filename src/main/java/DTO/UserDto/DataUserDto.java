...
public class DataUserDto {
    ...
    public DataUserDto(int id, String official_id, String provider_id, String full_name, String position, String organization_short_title, String provider_name, String phone, String email, RoleUserDto[] roles) {
        this.id = id;
