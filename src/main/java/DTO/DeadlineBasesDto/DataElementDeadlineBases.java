...
public class DataElementDeadlineBases {
    public int getId() {
        return id;
    }
    ...
    public DataElementDeadlineBases(int id, String name, String short_name, String note, DurationDeadlineBases duration, boolean deadline_only, boolean excluded, boolean deleted, int priority, String provider_id) {
        this.id = id;
        this.name = name;
        this.short_name = short_name;
        this.note = note;
