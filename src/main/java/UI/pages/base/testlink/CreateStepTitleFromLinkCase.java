package UI.pages.base.testlink;
...
public class CreateStepTitleFromLinkCase {
    ...
    String testCaseNumber = "82"; // задаем номер кейса
    ...
    public void createSteps() {
        try {
            ...
            allCases = allCases + "import org.testng.Assert;\n\n";
...
//            allCases = allCases + "page = new BasePage(b);\n";
            ...
            for (int i = 0; i < steps.size(); i++) {
                ...
                allCases = allCases + "@Test(enabled = true, description = \"[SKIP-" + testCaseNumber + " Step " + k + " " + initials + "] Шаги:\"\n";
                ...
                allCases = allCases + "public void SKIP_" + testCaseNumber + "_step_" + stepNumber + "() {\n";
