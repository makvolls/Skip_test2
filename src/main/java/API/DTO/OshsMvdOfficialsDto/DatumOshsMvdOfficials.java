...
public class DatumOshsMvdOfficials {
    public String id;
    public String last_name;
    public String short_name_with_org_and_pos;

    public DatumOshsMvdOfficials(String id, String last_name, String short_name_with_org_and_pos, String organization_short_title) {
        this.id = id;
