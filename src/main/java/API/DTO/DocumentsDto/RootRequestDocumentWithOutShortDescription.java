...
public class RootRequestDocumentWithOutShortDescription {
    ...
    public RootRequestDocumentWithOutShortDescription(String skip_reg_date, String control_official_id, int control_subject_id,
                                                      String document_name, int document_execution_state_id, int skip_document_type_id, boolean internal) {
