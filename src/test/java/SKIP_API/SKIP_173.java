...
public class SKIP_173 {
    ...
    int idDocumentFirst; // Document id element from list of documents
    String nameTemplate = "SKIP_173_Autotest";
    String shortNameTemplate = "SKIP_173";
    ...
    public void step01(){
        ...
        String headExecutorId = jsonPath.getString("data.assignments[0].head_executor.head_executor.id");
        int deadlineBasesId = jsonPath.getInt("data.assignments[0].head_executor.deadline_basis.id");
        int executionStateId = jsonPath.getInt("data.assignments[0].head_executor.execution_state.id");
        String coExecutorId = jsonPath.getString("data.assignments[0].head_executor.co_executors[0].co_executor_id");

        System.out.println("Head executor id - " + headExecutorId);
        System.out.println("Deadline bases id - " + deadlineBasesId);
        System.out.println("Execution state id - " + executionStateId);
        System.out.println("Co executor id - " + coExecutorId);

        Assert.assertTrue(headExecutorId.equals(idRandomEsdOrganization));
        Assert.assertTrue(deadlineBasesId == idDeadlineBases);
        Assert.assertTrue(executionStateId == idDocumentExecutionStateSecond);
        Assert.assertTrue(coExecutorId.equals(idRandomEsdOrganization));
    }
