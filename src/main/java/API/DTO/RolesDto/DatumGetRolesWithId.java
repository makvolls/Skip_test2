...
public class DatumGetRolesWithId {
    public int id;
    public String name;
    ...
    public DatumGetRolesWithId(int id, String name, String full_name, String provider_short_title, boolean global,
                               String[] rights_ids, String provider_id) {
        this.id = id;
        this.name = name;
