...
public class ControlFromOfficialDocumentDto {
    public String id;
    public String last_name;

    public ControlFromOfficialDocumentDto(String id, String last_name, String short_name_with_org_and_pos, String organization_short_title) {
        this.id = id;
